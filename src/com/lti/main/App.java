...
public class App {
	...
	/*
	 * public static void scenario5() { Course course = new Course(); Course course1
	 * = new Course(101, "ECE", 2, 12000); Course course2 = new Course(102, "CSE",
	 * 4, 15000); Course course3 = new Course(103, "IT", 2, 13000);
	 * 
	 * Info info = new Info(); info.display1(course1); info.display1(course2);
	 * info.display1(course3);
	 * 
	 * 
	 * } public static void scenario6() {
	 * 
	 * Course[] courses = new Course[3]; courses[0] = new Course(101, "ECE", 2,
	 * 123000); courses[1] = new Course(102, "IT", 4, 145000); courses[2] = new
	 * Course(103, "CSE", 5, 567000);
	 * 
	 * Info info = new Info(); info.display1(courses);
	 * 
	 ...
	 * System.out.println("Enter id, name, duration, fees"); int id = sc.nextInt();
	 * String name = sc.next(); int duration = sc.nextInt(); int fees =
	 * sc.nextInt();
	 * 
	 * courses[i] = new Course(id, name, duration, fees); }
	 * 
	 * Info.display1(courses); } public static void scenario8() {
	 * 
	 * List<Course> courses = new ArrayList<Course>(); Scanner sc = new
	 * Scanner(System.in); do {
	 * System.out.println("Enter your id,name,duration,fees"); int id =
	 * sc.nextInt(); String name = sc.next(); int duration = sc.nextInt(); int fees
	 * = sc.nextInt();
	 * 
	 * 
	 * // storing student object in collection courses.add(new Course(id, name,
	 * duration, fees)); System.out.println("Press 0 to stop?"); int num =
	 * sc.nextInt(); if (num == 0) break; } while (true);
	 * 
	...
	public static void scenario9() {
		...
		DiplomaCourse diplomaCourse=new DiplomaCourse(102,"Agri", 67, 20000, Type.Academic);
